          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" novalidate>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="tel" id="telephone" name="phone" readonly="readonly" required="required" data-validate-length-range="8,20" value="{{ $data->alamat }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
    <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="tel" id="telephone" name="phone" readonly="readonly" required="required" data-validate-length-range="8,20" value="{{ $data->no_hp }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
    <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="tel" id="telephone" name="phone" readonly="readonly" required="required" data-validate-length-range="8,20" value="{{ $data->semester }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
    <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Kebutuhan <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="tel" id="telephone" name="phone" readonly="readonly" required="required" data-validate-length-range="8,20" value="{{ $data->kebutuhan }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
    <div class="item form-group">
