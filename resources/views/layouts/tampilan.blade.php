            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ route('beranda') }}"><i class="fa fa-home"></i> Home <span class="label label-success pull-right"></span></a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Buat Surat <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('surat_aktif_kuliah.create') }}">Surat Aktif Kuliah</a></li>
                      <li><a href="{{ route('surat_tidak_menerima_beasiswa.create') }}">Surat Tidak Menerima Beasiswa</a></li>
                      <li><a href="{{ route('surat_rekomendasi_beasiswa.create') }}">Surat Rekomendasi Beasiswa</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Status Surat <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
