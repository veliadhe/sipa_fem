  ...
  <div class="">
   <div class="clearfix"></div>
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" novalidate>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="number" name="number" required="required" readonly="readonly" data-validate-minmax="10,100" value="{{ $data->nrp }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="url" id="website" name="website" required="required" readonly="readonly" placeholder="www.website.com" value="{{ $data->tempat_lahir }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="tel" id="telephone" name="phone" readonly="readonly" required="required" data-validate-length-range="8,20" value="{{ $data->departemen }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="item form-group">
    ...
    <div class="item form-group">
      ...
      <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Fotokopi KTM <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <img src="{{ asset('storage/'.$data->fcktm) }}" alt="" height="128">
                </div>
              </div>
    <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Fotokopi SPP <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <img src="{{ asset('storage/'.$data->fcspp) }}" alt="" height="128">
                </div>
              </div>
     <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone"> Formulir Beasiswa <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <a class="btn btn-success" href="{{ asset('storage/'.$data->formulir_beasiswa) }}" download="{{ $data->formulir_beasiswa}}">Download</a>
                </div>
              </div>
    <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Beasiswa yang pernah diambil <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <a class="btn btn-success" href="{{ asset('storage/'.$data->beasiswa) }}" download="{{ $data->beasiswa}}">Download</a>
                </div>
              </div>
    <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Surat Pernyataan Sedang Tidak Menerima Beasiswa <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <a class="btn btn-success" href="{{ asset('storage/'.$data->surat_pernyataan_sedang_tidak_menerima_beasiswa) }}" download="{{ $data->surat_pernyataan_sedang_tidak_menerima_beasiswa}}">Download</a>
                </div>
              </div>
